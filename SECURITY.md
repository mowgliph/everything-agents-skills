...
If you discover a security vulnerability in Everything Qwen Code, please report it responsibly.
...
- The Everything Qwen Code plugin and all scripts in this repository
- Hook scripts that execute on your machine
- Install/uninstall/repair lifecycle scripts
- MCP configurations shipped with Everything Qwen Code
