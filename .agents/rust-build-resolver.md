...
description: "Use this agent when working with rust-build-resolver tasks. Examples: <example>Context: User needs assistance with rust-build-resolver tasks. user: "Can you help me with " assistant: "I will use the rust-build-resolver agent to assist you with that." </example>"
color: yellow
---
