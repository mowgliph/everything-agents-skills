...
description: "Use this agent when working with cpp-build-resolver tasks. Examples: <example>Context: User needs assistance with cpp-build-resolver tasks. user: "Can you help me with " assistant: "I will use the cpp-build-resolver agent to assist you with that." </example>"
color: yellow
---
