...
description: "Use this agent when working with opensource-sanitizer tasks. Examples: <example>Context: User needs assistance with opensource-sanitizer tasks. user: "Can you help me with " assistant: "I will use the opensource-sanitizer agent to assist you with that." </example>"
color: magenta
---
