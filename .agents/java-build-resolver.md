...
description: "Use this agent when working with java-build-resolver tasks. Examples: <example>Context: User needs assistance with java-build-resolver tasks. user: "Can you help me with " assistant: "I will use the java-build-resolver agent to assist you with that." </example>"
color: yellow
---
