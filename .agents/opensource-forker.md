...
description: "Use this agent when working with opensource-forker tasks. Examples: <example>Context: User needs assistance with opensource-forker tasks. user: "Can you help me with " assistant: "I will use the opensource-forker agent to assist you with that." </example>"
color: magenta
---
