...
description: "Use this agent when working with opensource-packager tasks. Examples: <example>Context: User needs assistance with opensource-packager tasks. user: "Can you help me with " assistant: "I will use the opensource-packager agent to assist you with that." </example>"
color: magenta
---
